"""
Inpatient Lab Result model - stores lab results for IPD investigations
"""
...
class InpatientLabResult(Base):
    """Lab result model for inpatient investigations"""
    __tablename__ = "inpatient_lab_results"
    ...
    # Relationships
    investigation = relationship("InpatientInvestigation", back_populates="lab_result", uselist=False)
    
    def __repr__(self):
        return f"<InpatientLabResult {self.investigation_id}>"
