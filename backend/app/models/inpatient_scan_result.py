"""
Inpatient Scan Result model - stores scan results for IPD investigations
"""
...
class InpatientScanResult(Base):
    """Scan result model for inpatient investigations"""
    __tablename__ = "inpatient_scan_results"
    ...
    # Relationships
    investigation = relationship("InpatientInvestigation", back_populates="scan_result", uselist=False)
    
    def __repr__(self):
        return f"<InpatientScanResult {self.investigation_id}>"
