...
class User(Base):
    ...
    role = Column(String(50), nullable=False)  # Primary role: Records, Nurse, Doctor, PA, Anaesthetist, Billing, Pharmacy, Pharmacy Head, Store Manager, Lab, Lab Head, Scan, Scan Head, Xray, Xray Head, Claims, Admin, Auditor
