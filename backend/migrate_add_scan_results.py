"""
Migration script to create scan_results table
"""
import sqlite3
import os
...
def migrate():
    ...
    try:
        ...
        cursor.execute("CREATE INDEX ix_scan_results_investigation_id ON scan_results(investigation_id)")
        
        conn.commit()
        print("Successfully created scan_results table")
