"""
Migration: Create tables for inpatient documentation (SQLite version)
- nurse_notes
...
def migrate():
    """Create tables for inpatient documentation"""
    print("=" * 60)
    print("Migration: Create inpatient documentation tables")
    print("=" * 60)
    print()
