"""
Migration: Create tables for inpatient clinical review components (SQLite version)
...
def migrate():
    """Create tables for inpatient clinical review components"""
    print("=" * 60)
    print("Migration: Create inpatient clinical review tables")
    print("=" * 60)
    print()
