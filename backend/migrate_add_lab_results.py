"""
Migration script to create lab_results table
"""
import sqlite3
import os
...
def migrate():
    ...
    try:
        ...
        if cursor.fetchone():
            print("lab_results table already exists")
            conn.close()
            return
        ...
        cursor.execute("CREATE INDEX ix_lab_results_investigation_id ON lab_results(investigation_id)")
        
        conn.commit()
        print("Successfully created lab_results table")
