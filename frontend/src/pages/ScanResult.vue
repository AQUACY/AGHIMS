  ...
  <q-page class="q-pa-md">
    <div class="row items-center q-mb-md">
      <q-btn
        ...
        class="q-mr-md"
      />
      <div class="text-h4 text-weight-bold glass-text">Scan Result Entry</div>
    </div>
      ...
      <q-card-section>
        ...
        <div class="row q-gutter-md q-mt-md">
          ...
          <div class="col-12 col-md-4">
            ...
            <div class="text-body1 text-weight-medium">{{ scanResult?.entered_by_name || 'N/A' }}</div>
          </div>
          <div class="col-12 col-md-4">
            <div class="text-caption text-grey-7">Updated By</div>
            <div class="text-body1 text-weight-medium">{{ scanResult?.updated_by_name || 'N/A' }}</div>
          </div>
        </div>
      </q-card-section>
    </q-card>
