<template>
  <q-page class="hms-page">
    ...
    <section class="diag-panel">
      <div class="panel-head">
        <div>
          <div class="panel-title">Search and add X-ray</div>
    ...
    <section v-if="canManageActive" class="diag-panel">
      <div class="panel-head">
        <div>
          <div class="panel-title">Manage card list (Xray Head)</div>
          <div class="panel-sub">X-rays on the card list appear above. Add or remove them here.</div>
        </div>
      </div>
      <div class="panel-body">
