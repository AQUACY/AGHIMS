<template>
  <q-page class="hms-page">
    <HmsPageHeader title="Add investigation (Lab)">
      <template #actions>
    ...
    <section class="diag-panel">
      <div class="panel-head">
        <div>
          <div class="panel-title">Search and add investigation</div>
    ...
    <section v-if="canManageActive" class="diag-panel">
      <div class="panel-head">
        <div>
          <div class="panel-title">Manage card list (Lab Head)</div>
          <div class="panel-sub">Investigations on the card list appear above. Add or remove them here.</div>
        </div>
      </div>
      <div class="panel-body">
