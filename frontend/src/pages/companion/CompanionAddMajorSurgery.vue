<template>
  <q-page class="hms-page">
    <HmsPageHeader title="Add major surgery">
      <template #actions>
    ...
    <section class="diag-panel">
      <div class="panel-head">
        <div>
          <div class="panel-title">Search and add major surgery</div>
    ...
    <section v-if="canManageActive" class="diag-panel">
      <div class="panel-head">
        <div>
          ...
          <div class="panel-sub">Major surgeries on the card list appear above. Add or remove them here.</div>
        </div>
      </div>
      <div class="panel-body">
