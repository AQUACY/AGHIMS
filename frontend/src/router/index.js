  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'ClaimsPriceListManagement',
        component: () => import('../pages/PriceListManagement.vue'),
        meta: { requiresAuth: true, allowedRoles: ['Claims', 'Admin', 'Doctor', 'PA', 'Pharmacy Head', 'Store Manager'] },
      },
      {
...
const routeModuleMap = {
  ...
  'ClaimsPriceListManagement': 'price_list',
  ...
  'ClaimsIcd10DrgMapping': 'icd10_mapping',
